...
export const orgStructureService = {
    ...
    /**
     * Запустить проход сейчас, не дожидаясь расписания.
     *
     * Возвращает управление сразу: обход портала занимает минуты, и обратный
     * прокси столько не ждёт — раньше он обрывал запрос, администратор видел
     * ошибку, а проход шёл дальше и заканчивался успешно.
     *
     * Что вышло, смотрят в истории.
     */
    async syncNow() {
