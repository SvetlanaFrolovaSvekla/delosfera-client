// Модалка "Просмотр и сравнение редакций" — почти на весь экран, параллельный просмотр
// текста новой и предыдущей редакции ВНД (как в табе "Редакции", но в две колонки сразу),
