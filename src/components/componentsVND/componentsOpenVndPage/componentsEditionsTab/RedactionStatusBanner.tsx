...
function getBannerMessage(status: RedactionDisplayStatus, currentNumber?: number): string {
    switch (status) {
        case "draft":
            return "Черновик редакции. Пока не отправлена — доступна для правок.";
        case "pending":
            return "Редакция ожидает решения по согласованию.";
        case "rejected":
            return "Эта редакция была отклонена при согласовании и не стала действующей.";
        case "outdated":
            return `Внимание! Вы просматриваете текст устаревшей редакции документа. Использование текста этой редакции может привести к ошибкам при принятии решений. Действующая — Р${
                currentNumber ?? "—"
            }.`;
        default:
            return "";
