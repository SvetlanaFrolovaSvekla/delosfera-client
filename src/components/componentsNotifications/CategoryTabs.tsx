...
import {Star, Bell, FileText, Shield, ListChecks, MoreHorizontal, Users, FileSignature, ShoppingCart, BookOpenCheck} from "lucide-react";
...
const CATEGORY_ICONS: Record<string, React.ReactNode> = {
    ...
    Acknowledgement: <BookOpenCheck className="h-3.5 w-3.5"/>,
