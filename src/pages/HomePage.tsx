...
const activity = [
    {
        ...
        col: "#1c7a4d",
        bg: "#e2f4ea",
        text: "Б. Токтосунова согласовала редакцию 10084-Р1 ВНД \"Политика управления кредитными рисками\"\n",
        time: "12 мин назад"
    },
    {
        icon: "x" as const,
        col: "#c0392b",
        bg: "#fbe7e4",
        text: "А. Осмонов просрочил срок согласования редакции 10084-Р1 ВНД \"Политика управления кредитными рисками\" - был применен Автоакцепт",
        time: "52 мин назад"
    },
    {
        icon: "check" as const,
        col: "#2f68f5",
        bg: "#e9f0ff",
        text: "А. Нуруев добавил первую редакцию 10081-Р1 к ВНД \"Порядок работы с обеспечением (залогами)\"\n",
        time: "1 ч назад"
    },
    {
        icon: "vnd" as const,
        col: "#7a5ce0",
        bg: "#efeafe",
        text: "Редакция 10086-Р2 ВНД \"Кодекс корпоративной этики\n\" согласована, ВНД переведен в статус «Консолидация»",
        time: "2 ч назад"
    },
];
